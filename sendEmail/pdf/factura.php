...
//Consulta cliente
$consulta1 = $pdo->prepare("SELECT NUMCED_CLI, CONCAT (NOMBRE_CLI,' ',APELLIDO_CLI) AS NOM_APELL_CLI FROM CLIENTE where NUMCED_CLI = 1726639410;");
$consulta1->execute();
...
$pdf->Cell(190, 10, utf8_decode('Gracias ' . $resultado1[0]['NOM_APELL_CLI'] . ', por preferirnos. Disfrute su compra...'), 0, 1, 'L', 1);
