                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    foreach ($facturas  as $factura){
                      echo "<tr>
                        <td><i class='fab fa-angular fa-lg text-danger me-3'></i> <strong>${factura['ID_FACTURA']}</strong></td>
                        <td>${factura['ID_METPAGO']}</td>
                        <td>${factura['NUMCED_CLI']}</td>
                        <td>${factura['ID_PROMOCION']}</td>
                        <td>${factura['FECHCOMP_FACTURA']}</td>
                        <td>${factura['VALTOTAL_FACTURA']}</td>
                        <td>
                          <div class='dropdown'>
