...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Promociones/</span>Promos</h4>
              <button class="btn btn-primary py-2 mb-4" data-bs-toggle = "modal" data-bs-target = "#NuevaPromocion">Nueva Promocion</button>
              <!-- Form de Registro de Nueva Promo (Modal) -->
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <form class="modal-content needs-validation"  method="POST">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="Descripcion_Promo" class="form-label">Descripción</label>
                                    <input
                                      type="text"
                                      id="Descripcion_Promo"
                                      class="form-control"
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="Categoria_Promo" class="form-label">Categoria</label>
                                    <input
                                      type="text"
                                      id="Categoria_Promo"
                                      class="form-control"
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="Banner_Promo" class="form-label">Banner</label>
                                    <input
                                      type="text"
                                      id="Banner_Promo"
                                      class="form-control"
                        ...
                        <div class="modal fade modal" id="EditPromo" data-bs-backdrop="static" tabindex="-1">
                          ...
                          <form class="modal-content needs-validation"  method="POST">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="N_Descripcion_Promo" class="form-label">Descripción</label>
                                    <input
                                      type="text"
                                      id="N_Descripcion_Promo"
                                      class="form-control"
                                      placeholder="Ingrese una pequeña Descripcion"
                                      autofocus
                                    />
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="N_Categoria_Promo" class="form-label">Categoria</label>
                                    <input
                                      type="text"
                                      id="N_Categoria_Promo"
                                      class="form-control"
                                      placeholder="Ej:1"
                                    />
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="N_Banner_Promo" class="form-label">Banner</label>
                                    <input
                                      type="text"
                                      id="N_Banner_Promo"
                                      class="form-control"
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="EditarPromo" data-bs-dismiss="modal">
                                  Guardar
                                </button>
                              </div>
                            </form>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    foreach ($promos  as $promo){
                      echo "<tr>
                        <td><i class='fab fa-angular fa-lg text-danger me-3'></i> <strong>${promo['ID_PROMOCION']}</strong></td>
                        <td>${promo['DESCRIPCION_PROMOCION']}</td>
                        <td>${promo['CATEGORIA_PROMOCION']}</td>
                        <td> <img class='w-px-100 h-auto rounded' src='../../${promo['IMG_PROMOCION']}'</img></td>
                        <td>
                          <div class='dropdown'>
                            ...
                            <a class='dropdown-item' data-bs-toggle = 'modal' data-bs-target = '#NuevaPromocion'
                            ><i class='bx bx-bookmark-plus me-1'></i> Añadir</a
                          >
                              <a class='dropdown-item' data-bs-toggle = 'modal' data-bs-target = '#EditPromo' onclick='rellenarFormulario(${promo['ID_PROMOCION']})'
                                ><i class='bx bx-edit-alt me-1'></i> Edit</a
                              >
                              <a class='dropdown-item' id='${promo['ID_PROMOCION']}' onclick='Eliminar_Promocion(this.id)'
    ...
    <!-- Crud js -->
    <script src="../core/crud_Promociones/Insert_promo.js"></script>
    <script src="../core/crud_Promociones/Delete_promo.js"></script>
    <script src="../core/crud_Promociones/Update_promo.js"></script>
