(function($) {
    $.fn.htmlNumberSpinner = function () {
        ...
        $(this).find('.btn').css({"display":"inline-block","float": "right","margin":"0 auto", "width":"50px", "height":"30px", "font-size":"25px", "text-align":"center", "vertical-align":"middle", "line-height":"1", "cursor":"pointer", "user-select":"none"});
        incrementerEl$.css({"background-color":"#ECB365","margin":"0 auto","float": "right", "color":"white","border-radius":"20px"});
        decrementerEl$.css({"background-color":"#ECB365","margin":"0 auto","float": "right", "color":"white", "font-size":"25px","border-radius":"20px"});
        numberInput$.css({
            "margin":"0 auto",
