...
window.addEventListener("load", () => {
  ...
  function Estreno1() {
    Swal.fire({
      ...
      confirmButtonText: '<a href = "../Controller/Estrenos.php?ID=4"  style= "color:#041C3299; text-decoration: none; font-size:1rem;" >Adquiere tus boletos!!</a>',
  ...
  function Estreno2() {
    Swal.fire({
      ...
      confirmButtonText: '<a href = "../Controller/Estrenos.php?ID=2"  style= "color:#041C3299; text-decoration: none; font-size:1rem;" >Adquiere tus boletos!!</a>',
      confirmButtonColor: '#ECB365',
      showCloseButton: true
    });
  }
  function Estreno3() {
    Swal.fire({
      ...
      confirmButtonText: '<a href = "../Controller/Estrenos.php?ID=6"  style= "color:#041C3299; text-decoration: none; font-size:1rem;" >Adquiere tus boletos!!</a>',
      confirmButtonColor: '#ECB365',
      showCloseButton: true
    });
  }
  function Estreno4() {
    Swal.fire({
      ...
      confirmButtonText: '<a href="../Controller/Estrenos.php?ID=3" style= "color:#041C3299; text-decoration: none; font-size:1rem;" >Adquiere tus boletos!!</a>',
      confirmButtonColor: '#ECB365',
      showCloseButton: true
    });
  }
